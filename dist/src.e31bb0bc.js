...
// });
var timerAll = document.querySelector('#timer-1');
var daysOne = document.querySelector('.days-1');
var daysTwo = document.querySelector('.days-2');
var hoursOne = document.querySelector('.hours-1');
var hoursTwo = document.querySelector('.hours-2');
var minsOne = document.querySelector('.mins-1');
var minsTwo = document.querySelector('.mins-2');
var secsOne = document.querySelector('.secs-1');
var secsTwo = document.querySelector('.secs-2');
var timeOld = new Date('Jul 31, 2021');
setInterval(function () {
  var timeNow = Date.now();
  var timeNew = timeOld - timeNow;

  var _timeClok = timeClok(timeNew),
      days = _timeClok.days,
      hours = _timeClok.hours,
      mins = _timeClok.mins,
      secs = _timeClok.secs;
...
},{"lodash":"../node_modules/lodash/lodash.js","./sass/main.scss":"sass/main.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
